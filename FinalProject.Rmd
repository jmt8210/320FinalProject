...
Number of total penalties by a team was only able to predict the winner 50% of the time. As shown from the graphs, penalties vs. winning and losing were almost identical. This means that penalties is not a good predictor of wins.
