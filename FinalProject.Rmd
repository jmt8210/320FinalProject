...
Surprisingly, our logistic model has even better error than our random forest model, with an error of ~.186! Beyond this, the runtime for this is significantly lower, point to this as the superior model. Based on this analysis, and some comparisons between individual predictors with both models not included in this code, we will be using logistic regression to predict our games from here on out.
