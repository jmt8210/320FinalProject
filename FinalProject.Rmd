...
for(i in 1:nrow(teamGameStats2013)){
  teamGameStats2013[i,76] = teamGameStats2013[i, 59] - findTOP(as.character(teamGameStats2013[i,2]), as.double(teamGameStats2013[i,1]))
}

names(teamGameStats2013)[76] <- "timeOfPossessionDifferential"
